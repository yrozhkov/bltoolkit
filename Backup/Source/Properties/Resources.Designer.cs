...
namespace BLToolkit.Properties {
    ...
    internal class Resources {
        ...
        /// </summary>
        internal static string DataProviderVersionResolverBase_InvalidProviderType {
            get {
                return ResourceManager.GetString("DataProviderVersionResolverBase_InvalidProviderType", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to {0} ({1}) is not a registered data provider.
        /// </summary>
        internal static string DataProviderVersionResolverBase_ProviderIsNotRegistered {
            get {
                return ResourceManager.GetString("DataProviderVersionResolverBase_ProviderIsNotRegistered", resourceCulture);
            }
        }
